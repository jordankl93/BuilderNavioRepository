...
public abstract class NavioDAO extends DAOGeneric implements DAO<Navio>{
    ...
    public void insert(Navio obj) throws SQLException, ClassNotFoundException {
        ...
        String sql = "INSERT INTO USUARIO (QTDCARGA, QTDPASSAGEIROS, TIPO_NAVIO) VALUES ('" + obj.getCarga()+ "','" + obj.getPassageiro()+ "','" + obj.getTipoNavio().name() + "')";
    ...
    public void update(Navio obj) throws SQLException, ClassNotFoundException {
        ...
        String sql = "UPDATE USUARIO SET QTDCARGA='"+obj.getCarga()+"', QTDPASSAGEIROS='"+obj.getPassageiro()+"', TIPO_NAVIO='"+obj.getTipoNavio().name()+"' WHERE ID = "+obj.getId();
